...
/*! \mainpage libgp - Gaussian Process library for Machine Learning
 ...
 - this software was tested under Linux and MacOSX
...
\verbatim svn co https://libgp.svn.sourceforge.net/svnroot/libgp libgp
cd libgp
mkdir build \endverbatim
 -# Change into the build directory and compile:
 \verbatim cd build
cmake ..
make\endverbatim
 ...
 - @ref cov_group
 - @ref gp_example.cc "Example"
 - \subpage todo
 - \subpage faq
 - \subpage licence "Licensing"
